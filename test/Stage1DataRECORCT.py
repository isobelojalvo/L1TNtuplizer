...
options.register ('tauMaxPtTauVeto',  64, VarParsing.multiplicity.singleton, VarParsing.varType.int,
                  "Tau max Pt Tau Veto")
options.register ('tauIsoLUTFile',  "L1Trigger/L1TCalorimeter/data/tauIsoLutTest0.12Iso.txt", VarParsing.multiplicity.singleton, VarParsing.varType.string,
                  "Tau Isolation Cut")
options.register ('tauCalibLUTFile', "L1Trigger/L1TCalorimeter/data/tauCalibrationLUT_stage1.txt", VarParsing.multiplicity.singleton, VarParsing.varType.string,
                  "Tau Calibration LUT")
options.register ('RCTCalibrationMode', 'L1RCTParametersRcd_L1TDevelCollisions_ExtendedScaleFactorsV1', VarParsing.multiplicity.singleton, VarParsing.varType.string,
...
recordOverrides = { ('L1RCTParametersRcd', None) : (options.RCTCalibrationMode, None) }
process.GlobalTag = GlobalTag(process.GlobalTag, 'GR_P_V56', recordOverrides)
...
process.source.lumisToProcess = LumiList.LumiList(filename = '/afs/hep.wisc.edu/cms/ojalvo/stage1Emulator/CMSSW_7_4_4/src/L1Trigger/L1TCalorimeter/data/Cert_246908_251883_13TeV_PromptReco_Collisions15_JSON_v2.txt').getVLuminosityBlockRange()
...
#            tag = cms.string(options.RCTCalibrationMode)
#        ) 
#    ) 
#)
