#ifndef L1TNtuplizerStage2_H
#define L1TNtuplizerStage2_H
...
class L1TNtuplizerStage2 : public edm::EDAnalyzer {

 public:
  
  // Constructor
  L1TNtuplizerStage2(const edm::ParameterSet& ps);
  
  // Destructor
  virtual ~L1TNtuplizerStage2();
